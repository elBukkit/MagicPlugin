...
public class TorchAction extends BaseSpellAction
{
    ...
    private MaterialPredicateMap slippery;
	...
	public void initialize(Spell spell, ConfigurationSection parameters)
	{
		...
		slippery = spell.getController().getMaterialMap(parameters.getString("not_attachable", "not_attachable"));
	}
	...
	public SpellResult perform(CastContext context) {
		...
		if (slippery != null && slippery.apply(target.getState()))
		{
			return SpellResult.NO_TARGET;
		}
