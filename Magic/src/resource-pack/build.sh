...
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-skulls-RP-8-1.zip *
cd ..
...
cp -R ../../painterly/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-painterly-RP-8-1.zip *
cd ..
...
cp -R ../../potter/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-potter-RP-8-1.zip *
cd ..
...
cp -R ../../stars/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-stars-RP-8-1.zip *
cd ..
