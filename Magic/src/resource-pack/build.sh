...
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-skulls-RP-1.15.zip *
cd ..
...
cp -R ../../painterly/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-painterly-RP-1.15.zip *
cd ..
...
cp -R ../../potter/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-potter-RP-1.15.zip *
cd ..
...
cp -R ../../stars/* .
find . -name ".DS_Store" -type f -delete
zip -r -X ../Magic-stars-RP-1.15.zip *
cd ..
