...
import com.elmakers.mine.bukkit.utility.platform.modern.listener.EntityPickupListener;
...
public class Platform extends PlatformBase {
    ...
    protected MobUtils createMobUtils() {
        return new com.elmakers.mine.bukkit.utility.platform.modern.MobUtils(this);
    }
    ...
    protected SkinUtils createSkinUtils() {
        return new com.elmakers.mine.bukkit.utility.platform.modern.SkinUtils(this);
    }
