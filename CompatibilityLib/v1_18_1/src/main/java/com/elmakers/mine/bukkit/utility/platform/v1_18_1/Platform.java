...
import com.elmakers.mine.bukkit.utility.platform.v1_18_1.event.EntityLoadEventHandler;
...
public class Platform extends ModernPlatform {
    ...
    protected MobUtils createMobUtils() {
        return new com.elmakers.mine.bukkit.utility.platform.v1_18_1.MobUtils(this);
    }
