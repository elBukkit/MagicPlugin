...
import com.elmakers.mine.bukkit.utility.platform.v1_20_5.event.EntityLoadEventHandler;
...
public class Platform extends ModernPlatform {
    ...
    protected SkinUtils createSkinUtils() {
        return new com.elmakers.mine.bukkit.utility.platform.v1_20_5.SkinUtils(this);
    }
